...
const DocSelector = () => {
  ...
  const organizeClinicData = (clinics) => {
    console.log("Raw clinic data:", clinics);
    const organizedData = {};
    ...
    console.log("Organized clinic data:", organizedData);
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const organizedData = organizeClinicData(data);
        console.log("Organized clinic data:", organizedData);
        setClinics(organizedData);
      } else {
  ...
  const handleDoctorSelect = (clinicId, doctorIndex) => {
    setSelectedDoctor({ clinicId, doctorIndex });
    console.log(
      `Selected doctor: clinicId=${clinicId}, doctorIndex=${doctorIndex}`
    );
  };
