        ...
        <div className="selectbottom">
          ...
          <div className="selectbottomRight">
            {clinics.map((clinic, index) => (
              <div className="docHospInfo" key={`${clinic.clinic_id}-${index}`}>
                ...
                >
                  <div>
                    <img id="docPic" src={clinic.doctor_picture} alt="Doctor" />
                  </div>
                  <div>
                    <span id="docName">{clinic.doctor_name}</span>
                  </div>
                  <div className="hosDocInfoDetail">
                    <span id="docPro">{clinic.doctor_sub}</span>
                    <hr />
                    <span id="docYear">資歷{clinic.doctor_seniority}年</span>
                    <hr />
                    <span id="docProInfo">{clinic.doctor_info}</span>
                  </div>
                  <div>
